...
public class AppMainTabActivity extends BaseActivity implements OnClickListener, RFStarBLEBroadcastReceiver {
	/* Your Tab host */
	 ...
	 * 给Tab按钮设置图标和文�?
	 */
	private int mImageViewArray[] = { R.drawable.tab_temp_btn, R.drawable.tab_message_btn, R.drawable.tab_testsilk_btn, R.drawable.tab_baike_btn, R.drawable.tab_settings_btn };
	private String mTextviewArray[] = { "温度计", "用药提醒", "测病症", "百科", "设置" };
	...
	public void onBackPressed() {
		if (mStacks.get(mCurrentTab).lastElement() instanceof BaseFragment && ((BaseFragment) mStacks.get(mCurrentTab).lastElement()).onBackPressed() == false) {
			/*
	...
	public File tempFile = new File(Environment.getExternalStorageDirectory(), System.currentTimeMillis() + ".jpg");
	...
	private void showChoseImage() {
		...
		builder.setTitle("操作");
		builder.setItems(new String[] { "照相机", "本地图库" }, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int position) {
				...
				switch (position) {
				case 0:
					GraphicsBitmapUtils.startCamearPicCut(AppMainTabActivity.this, dialog, tempFile);
					break;
				case 1:
					GraphicsBitmapUtils.startImageCaptrue(AppMainTabActivity.this, dialog);
					break;
				default:
					break;
				}
