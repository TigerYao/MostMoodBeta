...
import com.rfstar.kevin.rfstar.kevin.app.AppManager.RFStarManageListener;
...
import com.temp.tiger.app.base.AppMainTabActivity;
...
public class SearchActivity extends BaseActivity implements
	...
	bleAdapter = new BAdapter(this, arraySource, deviceNames);
	...
	app.manager.cubicBLEDevice = new CubicBLEDevice(
		app.getApplicationContext(), app.manager.bluetoothDevice);
	app.manager.cubicBLEDevice.setBLEBroadcastDelegate(SearchActivity.this);
	String mac = app.manager.bluetoothDevice.getAddress();
	String userName = app.manager.bluetoothDevice.getName();
	Intent data = new Intent(this, AppMainTabActivity.class);
